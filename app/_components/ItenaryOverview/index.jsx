...
export default function ItenaryOverview() {
  ...
  return (
    <div className="-translate-y-28">
      <h5 className="text-center mb-4 uppercase text-light tracking-wide">Explore by Bike, Experience the mountains</h5>
      <div 
        className="relative grid grid-cols-2 lg:grid-cols-5 gap-x-3 gap-y-8 px-2 text-center pt-7 pb-10 bg-white drop-shadow-primary mb-10 max-w-6xl w-11/12 mx-auto rounded-xl "
      >
